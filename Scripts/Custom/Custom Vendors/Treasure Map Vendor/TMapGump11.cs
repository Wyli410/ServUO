...
{ public class TMapGump11 : Gump { 
public static void Initialize() { 
CommandSystem.Register( "TMapGump11", AccessLevel.GameMaster, new CommandEventHandler( TMapGump11_OnCommand ) ); 
}
private static void TMapGump11_OnCommand( CommandEventArgs e ) 
{
e.Mobile.SendGump( new TMapGump11( e.Mobile ) ); } 
public TMapGump11( Mobile owner ) : base( 50,50 ) 
{
//----------------------------------------------------------------------------------------------------
AddPage( 0 );AddImageTiled(  54, 33, 369, 400, 2624 );AddAlphaRegion( 54, 33, 369, 400 );AddImageTiled( 416, 39, 44, 389, 203 );
//--------------------------------------Window size bar--------------------------------------------
AddImage( 97, 49, 9005 );AddImageTiled( 58, 39, 29, 390, 10460 );AddImageTiled( 412, 37, 31, 389, 10460 );
AddLabel( 140, 60, 0x34, "The Treasure Map Swapper" );
//----------------------/----------------------------------------------/
AddHtml( 107, 140, 300, 230, " < BODY > " + 
"<BASEFONT COLOR=YELLOW>Ahoy, Matey.  Can we trade Treasure Maps? <BR>" +
"<BASEFONT COLOR=YELLOW><BR>" +
"<BASEFONT COLOR=YELLOW><BR>" +
"<BASEFONT COLOR=YELLOW>Bring me any Treasure Map and I will trade<BR>" +
"<BASEFONT COLOR=YELLOW>it!<BR>" +
"<BASEFONT COLOR=YELLOW><BR>" +
"<BASEFONT COLOR=YELLOW><BR>" +
"<BASEFONT COLOR=YELLOW><BR>" +
"<BASEFONT COLOR=YELLOW><BR>" +
