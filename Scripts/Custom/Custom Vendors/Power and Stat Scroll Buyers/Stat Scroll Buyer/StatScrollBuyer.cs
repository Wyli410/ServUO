...
{[CorpseName( "Paragonion's Corpse" )]public class Paragonion : Mobile{public virtual bool IsInvulnerable{ get{ return true; } }
[Constructable]public Paragonion(){
//////////////////////////////name
Name = "Paragonion";
/////////////////////////////////title
Title = "The Stat Scroll Buyer";
////////sex
Body = 0x191;
//////skincolor
Hue = 0x83EA;
...
public Paragonion( Serial serial ) : base( serial ){}
public override void GetContextMenuEntries( Mobile from, List<ContextMenuEntry> list ) 
{ base.GetContextMenuEntries( from, list ); list.Add( new ParagonionEntry( from, this ) ); } 
public override void Serialize( GenericWriter writer ){base.Serialize( writer );writer.Write( (int) 0 );}
public override void Deserialize( GenericReader reader ){base.Deserialize( reader );int version = reader.ReadInt();}
public class ParagonionEntry : ContextMenuEntry{private Mobile m_Mobile;private Mobile m_Giver;
public ParagonionEntry( Mobile from, Mobile giver ) : base( 6146, 3 ){m_Mobile = from;m_Giver = giver;}
public override void OnClick(){if( !( m_Mobile is PlayerMobile ) )return;
PlayerMobile mobile = (PlayerMobile) m_Mobile;{
///////////////////////////////////////////////// gumpname
if ( ! mobile.HasGump( typeof( PowerGump22 ) ) ){
mobile.SendGump( new PowerGump22( mobile ));}}}}
